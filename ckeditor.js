...
(function() {
	...
	CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
		...
		return {
			...
			on: function(b, d, f, k, l) {
				...
				if(0 > g.getListenerIndex(d)) {
					...
					for(var A = g.length - 1; 0 <= A; A--)
						if(g[A].priority <= l) return g.splice(A + 1, 0, q), {
							removeListener: t
						};
					g.unshift(q)
				}
					...
					if(g) {
						...
						if(A.length)
							for(var A = A.slice(0), v, C = 0; C < A.length; C++) {
								if(g.errorProof) try {
									v =
										A[C].call(this, t, q, b, k)
								} catch(n) {} else v = A[C].call(this, t, q, b, k);
			...
			removeListener: function(a, b) {
				var f = d(this)[a];
				if(f) {
					var k = f.getListenerIndex(b);
					0 <= k && f.listeners.splice(k, 1)
				}
			},
	...
	(function() {
		var a = [],
			...
			q = function(a, g) {
				return "#" == g[0] ? String.fromCharCode(parseInt(g.slice(1), 10)) : l[g]
			};
		...
		CKEDITOR.tools = {
			...
			setTimeout: function(a, b, c, l, d) {
				d || (d = window);
				c || (c = d);
				return d.setTimeout(function() {
						l ? a.apply(c, [].concat(l)) : a.apply(c)
					},
					b || 0)
			},
			trim: function() {
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		...
		getByAddress: function(a, d) {
			for(var b =
				...
				var e = a[c];
				if(d)
					for(var f = -1, k = 0; k < b.childNodes.length; k++) {
	...
	(function() {
		...
		function c(a) {
			for(var b = 0, c = 0, g = k[a].length; c < g; c++) b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
			return b
		}
			...
			mergeSiblings: function() {
				function a(b, c, g) {
					if(c && c.type == CKEDITOR.NODE_ELEMENT) {
						...
						if(b.isIdentical(c)) {
							for(var l = g ? b.getLast() : b.getFirst(); d.length;) d.shift().move(b, !g);
							c.moveChildren(b, !g);
							c.remove();
			...
			getDocumentPosition: function(a) {
				...
				if(document.documentElement.getBoundingClientRect) {
					var e = this.$.getBoundingClientRect(),
						...
						k = !0;
					CKEDITOR.env.ie && (k = g.getDocumentElement().contains(this), g = g.getBody().contains(this), k = A && g || !A && k);
					k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || f.scrollLeft, c = d.$.scrollTop || f.scrollTop) : (c = A ? d.$ : f, b = c.scrollLeft, c = c.scrollTop), b = e.left + b - y, c = e.top + c - n)
				} else
	...
	(function() {
		...
		var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
			...
			q = function(a) {
				return k(a) || f(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty)
			};
	...
	(function() {
		...
		function d(a, b, c, d, e) {
			function n(a, b, c, g) {
				...
				if(g && l) return d;
				h || g ? b.append(a.clone(!0, e), c) : (a.remove(), u && b.append(a));
				return d
			}
			...
			function k() {
				var b = I - 1,
					c = t && q && !p.equals(m);
				b < E - 1 || b < J - 1 || c ? (c ? a.moveToPosition(m,
			...
			var p = a.startContainer,
				...
				r = a.endOffset,
				G, B, t, q, M, S;
			if(h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(D, r)), c.append(p);
			else {
				m.type == CKEDITOR.NODE_TEXT ? h ? S = !0 : m = m.split(r) : 0 < m.getChildCount() ? r >= m.getChildCount() ? (m = m.getChild(r - 1), B = !0) : m = m.getChild(r) : q = B = !0;
				p.type == CKEDITOR.NODE_TEXT ? h ? M = !0 : p.split(D) : 0 < p.getChildCount() ? 0 === D ? (p = p.getChild(D), G = !0) : p = p.getChild(D - 1) : t = G = !0;
				for(var x = p.getParents(), H = m.getParents(), I = f(), E = x.length - 1, J = H.length - 1, O = c, K, aa, W, fa = -1, P = I; P <= E; P++) {
					aa =
						x[P];
					W = aa.getNext();
					for(P != E || aa.equals(H[P]) && E < J ? b && (K = O.append(aa.clone(0, e))) : G ? n(aa, O, !1, t) : M && O.append(a.document.createText(aa.substring(D))); W;) {
						if(W.equals(H[P])) {
							fa = P;
							break
						}
				...
				for(P = I; P <= J; P++)
					if(c = H[P], W = c.getPrevious(), c.equals(x[P])) b && (O = O.getChild(0));
						...
						P != J || c.equals(x[P]) && J < E ? b && (K = O.append(c.clone(0, e))) : B ? n(c, O, !1, q) : S && O.append(a.document.createText(c.substring(0, r)));
						if(P > fa)
							for(; W;) W = n(W, O, !0);
						O = K
					}
			...
			enlarge: function(a, b) {
				...
				switch(a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						r.type == CKEDITOR.NODE_TEXT ? (B && (r = !CKEDITOR.tools.trim(r.substring(0, B)).length && r, D = !!r), r && ((p = r.getPrevious()) || (h = r.getParent()))) :
							(B && (p = r.getChild(B - 1) || r.getLast()), p || (h = r));
						for(h = c(h); h || p;) {
							if(h && !p) {
								!m && h.equals(f) && (m = !0);
								if(e ? h.isBlockBoundary() : !k.contains(h)) break;
								D && "inline" == h.getComputedStyle("display") || (D = !1, m ? l = h : this.setStartBefore(h));
								p = h.getPrevious()
							}
							for(; p;)
								if(r = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
									...
									r && (D ? m ? l = h : h && this.setStartBefore(h) : D = !0);
									if(p) {
										r = p.getPrevious();
										if(!h && !r) {
											h = p;
						...
						r.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(r.substring(B)).length ? D = !0 : (D = !r.getLength(), B == r.getLength() ? (p = r.getNext()) ||
							(h = r.getParent()) : n(r, B) && (h = r.getParent())) : (p = r.getChild(B)) || (h = r);
						for(; h || p;) {
							if(h && !p) {
								!m && h.equals(f) && (m = !0);
								if(e ? h.isBlockBoundary() : !k.contains(h)) break;
								D && "inline" == h.getComputedStyle("display") || (D = !1, m ? u = h : h && this.setEndAfter(h));
								p = h.getNext()
							}
							for(; p;) {
								r = !1;
						...
						l && u && (f = l.contains(u) ? u : l, this.setStartBefore(f), this.setEndAfter(f));
						break;
			...
			shrink: function(a, b, c) {
				if(!this.collapsed) {
					...
					var d = this.clone(),
						...
						l = 1,
						u = 1;
					e && e.type == CKEDITOR.NODE_TEXT && (f ? f >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), l =
						0) : d.setStartBefore(e));
					n && n.type == CKEDITOR.NODE_TEXT && (k ? k >= n.getLength() ? d.setEndAfter(n) : (d.setEndAfter(n), u = 0) : d.setEndBefore(n));
	...
	(function() {
		...
		function b(a, c, e, f) {
			...
			if((k = CKEDITOR.filter.instances[f.element.data("cke-filter")]) && !k.check(c)) return b(a,
				c, e, f.remaining);c = new CKEDITOR.dom.range(f.element);c.selectNodeContents(f.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = k;a._.nestedEditable = {
				element: f.element,
				container: e,
		...
		a.prototype = {
			getNextParagraph: function(a) {
				...
				if(!this._.started) {
					...
					k = n.startPath();
					var y = n.endPath(),
						F = !n.collapsed && c(n, k.block),
						w = !n.collapsed && c(n, y.block, 1);
					n.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
					F && n.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
					...
					n.collapsed || (k = new CKEDITOR.dom.walker(n.clone()), y = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = y, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(n.clone()), k.evaluator = y, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, n.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (y = this.range.clone(), y.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), y.checkEndOfBlock() &&
						(y = new CKEDITOR.dom.elementPath(y.endContainer, y.root), this._.lastNode = (y.block || y.blockLimit).getNextSourceNode(!0))), this._.lastNode && n.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = n.document.createText(""), this._.lastNode.insertAfter(k)), n = null);
					this._.started = 1;
					k = n
				}
				y = this._.nextNode;
				...
				for(this._.nextNode = null; y;) {
					...
					if(u) y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (u = 0);
						...
						if(CKEDITOR.dtd.$block[p] && "false" == y.getAttribute("contenteditable")) {
							...
							if("br" == p) u = 1;
							else if(!k && !y.getChildCount() && "hr" != p) {
								d = y;
								A = y.equals(n);
								break
							}
							k && (k.setEndAt(y, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = y));
							F = 1
						} else {
							if(y.getFirst()) {
								k || (k = this.range.clone(), k.setStartAt(y, CKEDITOR.POSITION_BEFORE_START));
								y = y.getFirst();
								continue
							}
							u = 1
					...
					u && !k && (k = this.range.clone(), k.setStartAt(y, CKEDITOR.POSITION_BEFORE_START));
					A = (!F || u) && y.equals(n);
					if(k && !F)
						for(; !y.getNext(l) && !A;) {
							p = y.getParent();
					...
					u && k.setEndAt(y, CKEDITOR.POSITION_AFTER_END);
					y = this._getNextSourceNode(y, h, n);
					if((A = !y) || F && k) break
				}
				if(!d) {
	...
	(function() {
		function a(a, b, c, d, e) {
			...
			for(h in b) {
				...
				for(n in S) {
					...
					var E = m,
						...
						J = void 0;
					f ? G = !1 : f = {};
					for(J in D) "!" == J.charAt(0) && (J = J.slice(1), g.push(J), f[J] = !0, G = !1);
					for(; J = g.pop();) D[J] =
						D["!" + J], delete D["!" + J];
					E[u] = (G ? !1 : f) || null
				}
			...
			for(d = a.length; c < d; ++c) {
				...
				if(!0 === h.elements ||
					...
					for(l in m = h.elements, delete h.elements, m)
						if(b[l]) b[l][p ? "unshift" : "push"](h);
						else b[l] = [h]
			}
		}
					...
					if(a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
						...
						if(a)
							if(!0 === a) a = !0;
								...
								for(var e = 0, p = c.length, m; e < p; ++e) m = c[e], h[m] ||
									(h[m] = a(m));
								a = !1
							}
						else a = !1;
		...
		function g(a) {
			var b, c, d, h, p = {},
				e = 1;
			for(a = T(a); b = a.match(H);)(c = b[2]) ? (d = z(c, "styles"), h = z(c, "attrs"), c = z(c, "classes")) : d = h = c = null, p["$" + e++] = {
				elements: b[1],
				classes: c,
				styles: d,
				attributes: h
			...
			if(e.doFilter) {
				a: {
					...
					if(a || r) {
						...
						if(f)
							for(x = 0, k = f.length; x < k; ++x) c(f[x], b, g);
						if(a)
							for(x = 0, k = a.length; x < k; ++x) d(a[x], b, g, D);
						if(r)
							for(x = 0, k = r.length; x < k; ++x) d(r[x], b, g, D);
						a = g
					} else a = null
				}
				if(!a || !a.valid) return h.push(b), 1;k = a.validAttributes;
				var G = a.validStyles;
				r = a.validClasses;
				var u = b.attributes,
					l = b.styles,
				...
				var I = b.styleBackup,
					B, H, O = [],
					g = [],
					L = /^data-cke-/;x = !1;delete u.style;delete u["class"];delete b.classBackup;delete b.styleBackup;
				if(!a.allAttributes)
					for(B in u) k[B] || (L.test(B) ? B == (H = B.replace(/^data-cke-saved-/, "")) || k[H] || (delete u[B], x = !0) : (delete u[B], x = !0));
				if(!a.allStyles || a.hadInvalidStyle) {
					for(B in l) a.allStyles || G[B] ? O.push(B + ":" + l[B]) : x = !0;
		...
		function h(a, b, c) {
			...
			if(B.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
				...
				if("br" == b) a.previous && !u(a.previous) && (b = w(), b.insertBefore(a)), a.next && !u(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren();
					...
					b: {
						h = B[b];
						for(var e = 0, p = d.length, m; e < p; ++e)
							if(m = d[e], m.type == CKEDITOR.NODE_ELEMENT && !h[m.name]) {
								h = !1;
								break b
							}
						h = !0
					...
					if(h) a.name = b, a.attributes = {}, c.push({
						...
						h = a.parent;
						for(var e = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, r, n, p = d.length; 0 < p;) m = d[--p], e && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && B.$inline[m.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({
							check: "parent-down",
							el: r
						})), r.add(m, 0)) : (r = null, n = B[h.name] || B.span, m.insertAfter(a), h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || m.type != CKEDITOR.NODE_ELEMENT || n[m.name] || c.push({
							check: "el-up",
							el: m
						}));
						a.remove()
		...
		function m(a, b) {
			...
			for(e in d)
				if("class" == e)
					for(c = d[e].split(/\s+/), m = a.classes.join("|"); r = c.pop();) {
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, d) {
				...
				if("string" == typeof b) b = g(b);
					...
					d && (d =
						L(d), h.classes = d["class"] ? d["class"].split(/\s+/) : null, h.requiredClasses = h.classes, delete d["class"], h.attributes = d, h.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
			...
			applyTo: function(a, b, c, d) {
				...
				a.forEach(function(a) {
					if(a.type == CKEDITOR.NODE_ELEMENT) {
						...
						a: {
							...
							d = CKEDITOR.htmlParser.fragment.fromHtml(d);1 == d.children.length && (h = d.children[0]).type == CKEDITOR.NODE_ELEMENT && v(e, h, c, n);c = !c.length
						}
						c || p.push(a)
					}
				}, null, !0);
				...
				for(var E; c = p.pop();) c.type == CKEDITOR.NODE_ELEMENT ? h(c, d, a) : c.remove();
				for(; f = a.pop();)
					if(c = f.el, c.parent) switch(E = B[c.parent.name] || B.span, f.check) {
						case "it":
							B.$removeEmpty[c.name] && !c.children.length ? h(c, d, a) : y(c) || h(c, d, a);
							break;
						case "el-up":
							c.parent.type ==
								CKEDITOR.NODE_DOCUMENT_FRAGMENT || E[c.name] || h(c, d, a);
							break;
						case "parent-down":
							c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || E[c.name] || h(c.parent, d, a)
					}
					return u
			},
			...
			addContentForms: function(a) {
				if(!this.disabled && a) {
					...
					if(h) {
						for(b = 0; b < a.length; ++b) d.push(D(a[b], h));
				...
				if(!this.disabled && a) {
					...
					for(h = 0; h < a.length; ++h) {
						...
						var e = void 0,
							...
							f = void 0;
						c = [];
						for(p = 0; p < b.length; ++p) m = b[p], "string" == typeof m ? (m = m.split(/\s*:\s*/), u = m[0], n = null, f = m[1]) : (u = m.check, n = m.left, f = m.right), e || (e = m, e = e.element ? e.element : u ? u.match(/^([a-z0-9]+)/i)[0] :
							e.left.getDefinition().element), n instanceof CKEDITOR.style && (n = r(n)), c.push({
							check: u == e ? null : u,
							left: n,
			...
			check: function(a, b, c) {
				...
				if("string" == typeof a) {
					...
					h = d
				} else d = a.getDefinition(), h = d.styles, m = d.attributes || {}, h ? (h = L(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {}, h = {
					name: d.element,
					attributes: m,
				...
				var m = CKEDITOR.tools.clone(h),
					r = [],
					u;
				if(!1 !== b && (u = this._.transformations[h.name])) {
					for(d =
						0; d < u.length; ++d) p(this, h, u[d]);
					n(h)
				}
				v(this, m, r, {
					doFilter: !0,
			...
			O = CKEDITOR.filter.transformationsTools = {
				...
				transform: function(a, b) {
					if("string" == typeof b) a.name = b;
						...
						for(e in h)
							if("class" == e)
								for(c = a.classes.join("|"), m = h[e].split(/\s+/); r = m.pop();) - 1 == c.indexOf(r) && a.classes.push(r);
		...
		return {
			load: function(b, c, e, f) {
				...
				var l = b.length,
					...
					t = [],
					g = function(a) {
						c && (k ? c.call(e, a) : c.call(e, q, t))
					};
				if(0 === l) g(!0);
				else {
					var z = function(a, b) {
							(b ? q : t).push(a);
							0 >= --l && (f && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), g(b))
						},
						A = function(b, c) {
							a[b] = 1;
							var e = d[b];
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, d, b) {
			...
			for(var c = this.loaded, e = this.registered, f = [], k = {}, l = {}, q = 0; q < a.length; q++) {
				var t = a[q];
				if(t)
				...
				k = function(b) {
					a.call(this, b, function(a) {
						...
						for(g in a) {
							...
							if(!d[g]) {
								if(l.icons)
									for(var v = l.icons.split(","), C = v.length; C--;) CKEDITOR.skin.addIcon(v[C], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + v[C] + ".png");
								d[g] = 1
							}
							if(A)
								for(A.split && (A = A.split(",")), l = 0; l < A.length; l++) f[A[l]] || b.push(A[l])
						}
						if(b.length) k.call(this,
							b);
						else {
							for(g in f) l = f[g], l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete f[g], l.onLoad._called = 1);
							c && c.call(e || window, f)
						}
					}, this)
				};
		...
		function z(a) {
			...
			CKEDITOR.plugins.load(c.split(","), function(c) {
				...
				for(var f in c) {
					...
					if(l && (x = l.match(p)))
						for(; l = x.pop();) CKEDITOR.error("editor-plugin-required", {
							plugin: l.replace(",", ""),
							requiredBy: f
						});
					g && !a.lang[f] && (g.split && (g = g.split(",")), 0 <= CKEDITOR.tools.indexOf(g, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(g, k) ? k : 0 <= CKEDITOR.tools.indexOf(g, "en") ? "en" : g[0]), u.langEntries && u.langEntries[k] ? (a.lang[f] = u.langEntries[k], k = null) : e.push(CKEDITOR.getUrl(u.path + "lang/" + k + ".js")));
					h.push(k);
					d.push(u)
				}
	...
	(function() {
		...
		CKEDITOR.htmlParser.prototype = {
			...
			onComment: function() {},
			parse: function(b) {
				for(var c, e, f = 0, k; c = this._.htmlPartsRegex.exec(b);) {
					e = c.index;
					if(e > f)
						if(f = b.substring(f, e), k) k.push(f);
						else this.onText(f);
						...
						if(e = e.toLowerCase(), !/="/.test(e)) {
							...
							if(t)
								for(; q = a.exec(t);) {
									...
									q = q[2] || q[3] || q[4] || "";
									l[g] = !q && d[g] ? g : CKEDITOR.tools.htmlDecodeAttr(q)
								}
		...
		CKEDITOR.htmlParser.fragment.fromHtml =
			function(f, k, l) {
				function q(a) {
					...
					if(0 < y.length)
						for(var c = 0; c < y.length; c++) {
							...
							f && !f[h] || a && e && !e[a] && CKEDITOR.dtd[a] ? h == w.name && (z(w, w.parent, 1), c--) : (b || (t(), b = 1), d = d.clone(), d.parent = w, w = d, y.splice(c, 1), c--)
						}
				}
				...
				function z(b, c, d) {
					c = c || w || n;
					var e = w;
					void 0 === b.previous && (A(c, b) && (w = c, C.onTagOpen(l, {}), b.returnPoint = c = w), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (h = !1), "textarea" == b.name && (u = !1));
				...
				C.onTagClose = function(a) {
					...
					for(var c = [], d = [], h = w; h != n && h.name != a;) h._.isBlockLike || d.unshift(h), c.push(h), h = h.returnPoint || h.parent;
					if(h != n) {
				...
				C.onText = function(a) {
					if(!(w._.hasInlineStarted && !F.length || h || u) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
					var b = w.name,
	...
	(function() {
		...
		function d(b, c, d, f) {
			var k, l;
			for(k in c)(l = b[k]) || (l = b[k] = new a), l.add(c[k], d, f)
		}
		CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				onElement: function(a, c) {
					for(var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], f, k = 0; 3 > k; k++)
						if(f = d[k]) {
							f = f.exec(a, c, this);
							if(!1 === f) return null;
		...
		a.prototype = {
			...
			addMany: function(a,
				c, d) {
				for(var f = [this.findIndex(c), 0], k = 0, l = a.length; k < l; k++) f.push({
					value: a[k],
					priority: c,
					options: d
				});
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					q, t, g, z;
				for(z = 0; z < l; z++)
					if(d && (q = c.type, t = c.name), g = k[z], !(a.nonEditable && !g.options.applyToAll ||
			...
			execOnName: function(a, c) {
				for(var d = 0, f = this.rules, k = f.length, l; c && d < k; d++) l = f[d], a.nonEditable && !l.options.applyToAll || a.nestedEditable && l.options.excludeNestedEditable || (c = c.replace(l.value[0], l.value[1]));
				return c
			}
		}
	})();
	(function() {
				...
				return function(h) {
					if(h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var e = [],
							...
							u, E;
						if(p)
							for(r(p, 1) && e.push(p); p;) f(p) && (u = c(p)) && r(u) && ((E = c(u)) && !f(E) ? e.push(u) : (m(g).insertAfter(u), u.remove())), p = p.previous;
						for(p = 0; p < e.length; p++) e[p].remove();
						if(e = !a || !1 !== ("function" == typeof d ? d(h) : d)) g || CKEDITOR.env.needsBrFiller ||
							h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? g || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (e = b(h), e = !e || "form" == h.name && "input" == e.name) : e = !1 : e = !1;
						e && h.add(m(a))
					}
				}
			}
					...
					if(b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
							...
							for(d = b.next; d && e(d);) d =
								d.next;
							var h = c(b);
							!d && f(b.parent) ? k(b.parent, m(a)) : f(d) && h && !f(h) && m(a).insertBefore(d)
						}
					}
				}
			}(g);
		...
		function n(a, b) {
			...
			return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, h) {
				return "\x3c" + c + d + "\x3e" + C(v(h), b) + "\x3c/" + c + "\x3e"
			})
		}
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml: function(a, b, c, d) {
				var h = this.editor,
					e, m, p, r;
				b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, m = b.filter, p = b.enterMode, r = b.protectedWhitespaces) : e = b;
		...
		var y = /(?:&nbsp;|\xa0)$/,
			...
			h = CKEDITOR.tools.extend({}, w.$blockLimit,
				w.$block),
			p = {
				elements: {
					input: l,
	...
	(function() {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
				...
				for(q in k) {
					for(l = k[q];;)
						if(t = a.onAttributeName(b, q))
							if(t != q) delete k[q], q = t;
							else break;
					else {
						delete k[q];
						break
					}
					t && (!1 === (l = a.onAttribute(b, d, t, l)) ? delete k[t] :
						k[t] = l)
				}
			...
			writeHtml: function(a, b) {
				...
				q = 0;
				for(t = k.length; q < t; q++) l = k[q], a.attribute(l[0], l[1]);
	...
	(function() {
		...
		CKEDITOR.template = function(f) {
			if(a[f]) this.output = a[f];
				...
				var k = f.replace(b, "\\$1").replace(c, "\\n").replace(e, "\\r").replace(d, function(a, b) {
					return "',data['" + b + "']\x3d\x3dundefined?'{" + b + "}':data['" + b + "'],'"
				});
				this.output = a[f] = Function("data", "buffer", "return buffer?buffer.push('" + k + "'):['" + k + "'].join('');")
			}
		}
	})();
	delete CKEDITOR.loadFullCore;
	...
	(function() {
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
			...
			k.setSize("width", a, !0);
			t && (t.style.width = "1%");
			var g = (k.$.offsetHeight || 0) - (q.$.clientHeight ||
					0),
				l = Math.max(b - (d ? 0 : g), 0);
			b = d ? b + g : b;
	...
	(function() {
		function a(a) {
			...
			k(b, e.block, m) && r.collapsed && !r.getCommonAncestor().isReadOnly() && (e = r.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), m = new CKEDITOR.dom.walker(e), m.guard = function(a) {
		...
		function f(a) {
			function b(a) {
				return function(b, h) {
					h && b.type == CKEDITOR.NODE_ELEMENT && b.is(g) && (d = b);
					if(!(h || !c(b) || a && v(b))) return !1
				}
			}
						...
						this.attachListener(a, "key", function(b) {
							...
							if(c in k) {
								...
								var h, e = b.getRanges()[0],
									m = e.startPath(),
									p, x, l, c = 8 == c;
								CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (h = b.getSelectedElement()) || (h = f(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(h, CKEDITOR.POSITION_BEFORE_START), h.remove(), e.select(), a.fire("saveSnapshot"), d = 1) : e.collapsed && ((p = m.block) && (l = p[c ? "getPrevious" :
									...
									e.checkStartOfBlock() && e.checkEndOfBlock() ? l.remove() : e.select(), a.fire("saveSnapshot"), d = 1) : (x = m.contains(["td", "th", "caption"])) && e.checkBoundaryOfElement(x, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
							}
							return !d
						});
						...
						CKEDITOR.env.webkit && this.attachListener(a,
							...
							function(b) {
								...
								if(b in k) {
									...
									else c = d, m = b.block, d = c.endPath().block, m && d && !m.equals(d) ? (a.fire("saveSnapshot"), (h = m.getBogus()) && h.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(m, !1), b.lastElement.mergeSiblings(), t(m, d, !0)), c = a.getSelection().getRanges()[0],
		...
		var g = CKEDITOR.dom.walker.whitespaces(!0),
			...
			n = function() {
				...
				function b(c, d) {
					...
					e = d.range.startPath();
					for(var k = B[k.getName()], r = 0, D = c.getChildren(), l = D.count(), G = -1, n = -1, t = 0, q = e.contains(B.$list); r <
						l; ++r) e = D.getItem(r), a(e) ? (g = e.getName(), q && g in CKEDITOR.dtd.$list ? f = f.concat(b(e, d)) : (p = !!k[g], "br" != g || !e.data("cke-eol") || r && r != l - 1 || (t = (m = r ? f[r - 1].node : D.getItem(r + 1)) && (!a(m) || !m.is("br")), m = m && a(m) && B.$block[m.getName()]), -1 != G || p || (G = r), p || (n = r), f.push({
						isElement: 1,
						isLineBreak: t,
				...
				function d(b, c) {
					...
					for(r && e.push(" "); f < m; f++) g = h.getItem(f), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g);
					r && e.push(" ");
					return e
				}
				...
				return function(n, x, H, I) {
					...
					if(!I.checkReadOnly()) {
						...
						I = n.mergeCandidates;
						var K, v;
						"text" == n.type && x.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (K = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", x.document), x.insertNode(K), x.setStartAfter(K));
						J = new CKEDITOR.dom.elementPath(x.startContainer);
						n.endPath = L = new CKEDITOR.dom.elementPath(x.endContainer);
						if(!x.collapsed) {
							var E = L.block || L.blockLimit,
								y = x.getCommonAncestor();
							E && !E.equals(y) && !E.contains(y) && x.checkEndOfBlock() && n.zombies.push(E);
							x.deleteContents()
						}
						for(;
							(v = e(x)) && a(v) && v.isBlockBoundary() && J.contains(v);) x.moveToPosition(v, CKEDITOR.POSITION_BEFORE_END);
						f(x, n.blockLimit, J, L);
						K && (x.setEndBefore(K), x.collapse(), K.remove());
						K = x.startPath();
						if(E = K.contains(g, !1, 1)) x.splitElement(E), n.inlineStylesRoot = E, n.inlineStylesPeak = K.lastElement;
						K = x.createBookmark();
						(E = K.startNode.getPrevious(c)) && a(E) && g(E) && I.push(E);
						(E = K.startNode.getNext(c)) && a(E) && g(E) && I.push(E);
						for(E = K.startNode;
						...
						if(K = H) {
							...
							v = K.document.createElement("body");
							v.setHtml(H);
							...
							if((A = K.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
								...
								if(1 == v.getChildCount() && a(z = v.getFirst()) && z.is(t) && !z.hasAttribute("contenteditable")) {
									...
									K = 0;
									for(I = A.count(); K < I; K++)
										if(x = A.getItem(K), !x.is(q)) break a;
						...
						if(K) {
							...
							var R, X;
							x = z.startContainer;
							var J = n.endPath.elements[0],
								Y, L = J.getPosition(x),
								y = !!J.getCommonAncestor(x) && L != CKEDITOR.POSITION_IDENTICAL && !(L & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
							x = b(n.dataWrapper, n);
							for(G(x, z); I < x.length; I++) {
								...
								if(w = L.isLineBreak) {
									...
									var U = void 0,
										ba = void 0;
									L.hasBlockSibling ? w = 1 : (U = w.startContainer.getAscendant(B.$block, 1)) && U.is({
										div: 1,
										p: 1
								...
								if(w) H = 0 < I;
									...
									w =
										z.startPath();
									!L.isBlock && k(n.editor, w.block, w.blockLimit) && (F = l(n.editor)) && (F = K.createElement(F), F.appendBogus(), z.insertNode(F), CKEDITOR.env.needsBrFiller && (C = F.getBogus()) && C.remove(), z.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END));
									if((w = z.startPath().block) && !w.equals(N)) {
										if(C = w.getBogus()) C.remove(), A.push(w);
										N = w
									}
									L.firstNotAllowed && (E = 1);
									if(E && L.isElement) {
										w = z.startContainer;
										for(R = null; w && !B[w.getName()][L.name];) {
											if(w.equals(v)) {
												w = null;
												break
											}
									...
									L.lastNotAllowed && I < x.length - 1 && ((X = y ? J : X) && z.setEndAt(X, CKEDITOR.POSITION_AFTER_START), E = 0);
									z.collapse()
								}
							}
					...
					list: {
						detectMerge: function(a, b) {
							var d = c(b, a.bookmark),
								...
								f = h.contains(CKEDITOR.dtd.$list);
							a.mergeList = g && f && g.getParent().equals(f.getParent()) && !g.equals(f);
					...
					table: function() {
						function a(c) {
							...
							g.guard = function(a,
								...
								if(g && m && a.equals(m)) h = c.clone(), h.setEndAt(m, CKEDITOR.POSITION_BEFORE_END), e.push(h);
								else if(!g && f && a.equals(f)) h = c.clone(), h.setStartAt(f, CKEDITOR.POSITION_AFTER_START), e.push(h);
								else {
									if(k = !g) k = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!m || b(a, m)) && (!f || b(a, f));
									k && (h = c.clone(), h.selectNodeContents(a), e.push(h))
								}
							};
							g.lastForward();
						...
						return {
							...
							detectRanges: function(e, h) {
								var g = c(h, e.bookmark),
									f = g.clone(),
									k, l, x = g.getCommonAncestor();
								x.is(CKEDITOR.dtd.$tableContent) && !x.is(d) && (x = x.getAscendant("table", !0));
								l = x;
								x = new CKEDITOR.dom.elementPath(g.startContainer, l);
								l = new CKEDITOR.dom.elementPath(g.endContainer, l);
								x = x.contains("table");
								l = l.contains("table");
								if(x || l) x && l && b(x, l) ? (e.tableSurroundingRange =
									f, f.setStartAt(x, CKEDITOR.POSITION_AFTER_END), f.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), f = g.clone(), f.setEndAt(x, CKEDITOR.POSITION_AFTER_END), k = g.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), k = a(f).concat(a(k))) : x ? l || (e.tableSurroundingRange = f, f.setStartAt(x, CKEDITOR.POSITION_AFTER_END), g.setEndAt(x, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = f, f.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g.setStartAt(l, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = k ? k : a(g)
							},
	...
	(function() {
				...
				if(!c.collapsed) {
					...
					d.evaluator = function(d) {
						if(d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
							...
							d.getPosition(k.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d),
			...
			e.on("contentDom", function() {
				...
				function c() {
					...
					var a = CKEDITOR.document.$.selection,
						b = a.createRange();
					"None" != a.type && b.parentElement().ownerDocument == h.$ && b.select()
				}
				var h = e.document,
					g = CKEDITOR.document,
					f = e.editable(),
				...
				f.attachListener(f, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
					x && CKEDITOR.env.webkit &&
						(x = e._.previousActive && e._.previousActive.equals(h.getActive()));
					e.unlockSelection(x);
					x = 0
				}, null, null, -1);
				...
				if(CKEDITOR.env.ie && !n) {
					...
					if("BackCompat" != h.$.compatMode) {
						if(CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) l.on("mousedown", function(a) {
							function b(a) {
								...
								if(d) {
									...
									d.setEndPoint(0 >
										h.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
									d.select()
								}
							}
						...
						if(7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) l.on("mousedown",
							function(a) {
								a.data.getTarget().is("html") && (g.on("mouseup", c), l.on("mouseup", c))
							})
					}
				}
				...
				if(n && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
					...
					f.attachListener(h.getDocumentElement(), "mouseup", function() {
						E && d.call(e);
						E = 0
					})
				} else f.attachListener(CKEDITOR.env.ie ?
					f : h.getDocumentElement(), "mouseup", d, e);
				CKEDITOR.env.webkit && f.attachListener(h, "keydown", function(a) {
		...
		CKEDITOR.on("instanceReady", function(a) {
			...
			CKEDITOR.env.webkit && (d.on("selectionChange", function() {
					var a = d.editable(),
						b = f(a);
					b && (b.getCustomData("ready") ? k(a) : b.setCustomData("ready", 1))
				}, null,
			...
			getRanges: function() {
				var a = F ? function() {
					...
					var b = function(b, c) {
						...
						for(var e = d.children, g, h, f = b.duplicate(), k = 0,
								x = e.length - 1, l = -1, m, n; k <= x;)
							if(l = Math.floor((k + x) / 2), g = e[l], f.moveToElementText(g), m = f.compareEndPoints("StartToStart", b), 0 < m) x = l - 1;
							else if(0 > m) k = l + 1;
						else return {
							container: d,
							offset: a(g)
						};
						if(-1 == l || l == e.length - 1 && 0 > m) {
							f.moveToElementText(d);
							f.setEndPoint("StartToStart", b);
							f = f.text.replace(/(\r\n|\r)/g, "\n").length;
							e = d.childNodes;
							if(!f) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? {
								container: d,
								offset: e.length
							} : {
								container: g,
							...
							for(d = e.length; 0 < f && 0 < d;) h = e[--d], h.nodeType ==
								CKEDITOR.NODE_TEXT && (n = h, f -= h.nodeValue.length);
							return {
								container: n,
								offset: -f
							}
						...
						f.collapse(0 < m ? !0 : !1);
						f.setEndPoint(0 < m ? "StartToStart" : "EndToStart", b);
						f = f.text.replace(/(\r\n|\r)/g, "\n").length;
						if(!f) return {
							container: d,
							offset: a(g) + (0 < m ? 0 : 1)
						...
						for(; 0 < f;) try {
							h = g[0 < m ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (f -= h.nodeValue.length, n = h), g = h
						} catch(t) {
							return {
								container: d,
								offset: a(g)
						...
						return {
							container: n,
							offset: 0 < m ? -f : n.nodeValue.length + f
						}
					};
					return function() {
						...
						if(d == CKEDITOR.SELECTION_ELEMENT) {
							for(var d = [], e = 0; e < c.length; e++) {
								for(var g = c.item(e), h = g.parentNode, f = 0, a = new CKEDITOR.dom.range(this.root); f <
									h.childNodes.length && h.childNodes[f] != g; f++);
			...
			selectRanges: function(a) {
				...
				if(a.length)
					if(this.isLocked) {
						...
						a: {
							var l, n;
							if(1 == a.length && !(n = a[0]).collapsed && (f = n.getEnclosedNode()) && f.type == CKEDITOR.NODE_ELEMENT && (n = n.clone(), n.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = n.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (f = l), "false" == f.getAttribute("contenteditable"))) break a;
							f = void 0
						}
						if(f) this.fake(f);
						else {
							if(F) {
								...
								g ? (l = f.document.$.body.createTextRange(), l.moveToElementText(g.$), v.setEndPoint("EndToEnd", l), v.moveEnd("character", -1)) : (t = b.getNext(n), q = b.hasAscendant("pre"), t = !(t && t.getText && t.getText().match(l)) && (q || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")),
								...
								for(v = 0; v < a.length; v++) {
									if(v < a.length - 1 && (t = a[v], q = a[v + 1], l = t.clone(), l.setStart(t.endContainer,
											t.endOffset), l.setEnd(q.startContainer, q.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), f = l.getCommonAncestor(), l = l.getEnclosedNode(), f.isReadOnly() || l && l.isReadOnly()))) {
									...
									f.collapsed && CKEDITOR.env.webkit && e(f) && (t = this.root, k(t, !1), l = t.getDocument().createText("​"), t.setCustomData("cke-fillingChar", l), f.insertNode(l), (t = l.getNext()) && !l.getPrevious() && t.type == CKEDITOR.NODE_ELEMENT &&
										"br" == t.getName() ? (k(this.root), f.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START)) : f.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
			...
			if(c.collapsed) g = F(this, g), c.insertNode(g), c.moveToPosition(g, CKEDITOR.POSITION_BEFORE_END);
				...
				for(r.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					...
					if(r.equals(q)) r = null, l = !0;
						...
						if(y)
							if(B = r.getParent(), y = h, D = f, G = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !G || y.parentRule && !y.parentRule(B)) l = !0;
							else {
								if(v ||
									...
									for(var w = r, Z;
										(l = !w.getNext(L)) && (Z = w.getParent(), m[Z.getName()]) && d(Z, t, h, S);) w = Z;
									v.setEndAfter(w)
								}
							}
						else l = !0;
					...
					if(l && v && !v.collapsed) {
						for(var l = F(this, g), u = l.hasAttributes(), z = v.getCommonAncestor(), w = {}, y = {}, B = {}, D = {}, V, Q, da; l && z;) {
							if(z.getName() == f) {
								for(V in h.attributes) !D[V] && (da = z.getAttribute(Q)) &&
									(l.getAttribute(V) == da ? y[V] = 1 : D[V] = 1);
								for(Q in h.styles) !B[Q] && (da = z.getStyle(Q)) && (l.getStyle(Q) == da ? w[Q] = 1 : B[Q] = 1)
							}
							z = z.getParent()
						}
						...
						l ? (v.extractContents().appendTo(l), v.insertNode(l), C.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), v.extractContents().appendTo(l), v.insertNode(l), C.call(this, l), l.remove(!0));
						v = null
					}
				}
				c.moveToBookmark(p);
			...
			if(a.collapsed) {
				for(var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, f = 0, k; f < e.elements.length && (k = e.elements[f]) && k != e.block && k != e.blockLimit; f++)
					if(this.checkElementRemovable(k)) {
						var l;
						a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = l ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? v.call(this, k) : n(k, h(this)[k.getName()]))
					}
				if(g) {
					k = d;
					for(f = 0;; f++) {
				...
				var m = c.endNode,
					p = this;
				b();
				for(e = d; !e.equals(m);) g = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? v.call(this, e) : n(e, h(this)[e.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), e = g
			}
			a.moveToBookmark(c);
		...
		function v(a, b) {
			...
			for(var k in c) this._.definition.fullMatch && a.getStyle(k) != p(k, c[k], !0) || (g = g || !!a.getStyle(k), a.removeStyle(k));
			n(a, e, D[a.getName()]);
		...
		function C(a) {
			for(var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || v.call(this, d, !0);
			for(var g in b)
				if(g != this.element)
		...
		CKEDITOR.dom.elementPath = function(b, e) {
			...
			do
				if(q.type == CKEDITOR.NODE_ELEMENT) {
					...
					if(q.equals(e)) break;
					if(!k && (t = q.getName(),
							"true" == q.getAttribute("contenteditable") ? k = q : !f && d[t] && (f = q), a[t])) {
						if(t = !f && "div" == t) {
							a: {
								t = q.getChildren();
		...
		var d = {
				...
				return {
					getNextRange: function(k) {
						...
						if(l && 1 < a.length) {
							...
							for(l.moveToBookmark(d.shift()); t--;) q = a[++f], q.moveToBookmark(d.shift()), l.setEnd(q.endContainer, q.endOffset)
						}
						return l
					}
				}
			...
			createBookmarks: function(b) {
				for(var c = [], d, f = 0; f < this.length; f++) {
					...
					for(var k = f + 1; k < this.length; k++) this[k] = a(d, this[k]), this[k] = a(d, this[k], !0)
				}
				return c
			},
			createBookmarks2: function(a) {
			...
			for(var k = 0; k < a.length; k++)
				if(CKEDITOR.env.webkit)
					for(e = 0; e < b.length; e++) {
						...
						a[k].$.sheet.addRule(b[e][0], f)
					} else {
						f = b;
						for(d = 0; d < c.length; d++) f = f.replace(c[d][0], c[d][1]);
						CKEDITOR.env.ie && 11 > CKEDITOR.env.version ?
							a[k].$.styleSheet.cssText += f : a[k].$.innerHTML += f
					}
		}
		var f = {};
		CKEDITOR.skin = {
